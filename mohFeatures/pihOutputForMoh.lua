...
-- DebugUtil.printTableRecursively(slotTable,"_",0,2)
	...
	if viewIsFiltered then
		...
		for _, productionData in ipairs(ProductionInfoHud.productionDataSorted) do
			...
			if productionData.capacityLevel ~= nil and productionData.capacityLevel > pihConfigForMoh.values.capacityLevelFilter and productionData.hoursLeft ~= nil and productionData.hoursLeft >= 0 then
