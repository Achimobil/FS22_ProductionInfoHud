...
function pihSetGetForMoh:loadCmds()
	...
	local isGenerate, errorTxt = g_currentMission.multiOverlayV4.cmdFunction.generateCmd( { 
			...
			ownTable = { showMissingAmount = false, filterForFillType = nil, filterForProduction = nil, openProductions = {} };	--by HappyLooser Info / Optional kannst du hier werte oder so hinterlegen dieses table wird dir immer mit übergeben beim callback, der wert kommt in args mit
			typ = {"output_"}; 
